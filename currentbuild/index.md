...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/mal/jostein/ImplementationGuide/hl7.fhir.no.mal.jostein | *Version*:0.1.0 |
| Draft as of 2025-11-10 | *Computable Name*:Jostein_Mal |
...
```json
{
  ...
  "id" : "hl7.fhir.no.mal.jostein",
  "url" : "http://hl7.no/fhir/ig/mal/jostein/ImplementationGuide/hl7.fhir.no.mal.jostein",
  "version" : "0.1.0",
  "name" : "Jostein_Mal",
  "title" : "Jostein_Mal",
  "status" : "draft",
  "date" : "2025-11-10T12:24:32+00:00",
  ...
  "description" : "Implementasjonsguide for å x_ehin_encounter",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "packageId" : "hl7.fhir.no.mal.jostein",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [
    {
  ...
  "definition" : {
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://hl7.no/fhir/ig/mal/jostein/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      ...
      },
      {
        ...
        "exampleCanonical" : "http://hl7.no/fhir/ig/mal/jostein/StructureDefinition/mal-patient"
      }
    ],
    "page" : {
      "extension" : [
