...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/mal/jostein/StructureDefinition/mal-observation-blodprove | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.no.mal.jostein|current/StructureDefinition/mal-observation-blodprove)
...
```json
{
  ...
  "url" : "http://hl7.no/fhir/ig/mal/jostein/StructureDefinition/mal-observation-blodprove",
  "version" : "0.1.0",
        ...
        "type" : [
          {
            "code" : "Reference",
            "targetProfile" : [
              "http://hl7.no/fhir/ig/mal/jostein/StructureDefinition/mal-patient"
            ]
          }
        ]
      },
